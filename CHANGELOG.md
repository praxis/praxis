...
* ...
* add a new praxis config `enable_praxis_stats` (default enabled). This allows you to control if the stats callbacks are registered at all. It's best to keep it disabled if you're not using that interface.
