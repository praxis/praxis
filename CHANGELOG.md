...
* Added `MediaTypeIdentifier` class to parse and manipulate type identifiers.
* Created a registry for media type handlers that parse and generate document bodies.
